...
get_mapeos_simple <- function(term, target_vocab) {
...
print(get_mapeos_simple("D72","SNOMED"))
...
get_top10_codes_mapeo_vecinos <- function(source_code, target_vocab, max_results = 10) {
  ...
  while (length(queue) > 0 && length(result_set) < max_results) {
    ...
    mapeos_actuales <- get_mapeos_simple(current_code, target_vocab)
...
get_top10_codes_mapeo_vecinos("90708001", "CIAP1")
